...
url = "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=margarita" # Url API
response = requests.get(url) # Формирование запроса 

 # Если на запрос у нас успешный ответ, то формируем список Coctail_list и записываем в него информацию:  
